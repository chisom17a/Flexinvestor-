...
export function useDoc<T = any>(
  ...
  // Safety check to enforce memoization and prevent infinite loops
  if (memoizedDocRef && !(memoizedDocRef as any).__memo) {
    throw new Error(`DocumentReference to "${memoizedDocRef.path}" was not properly memoized using useMemoFirebase`);
  }
